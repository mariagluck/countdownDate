const anniversaryDate = new Date("Jul 24, 2031 00:00:00").getTime();
...
<b style='font-size: 2.6em; color:white'>\ ${days}</b>` + 
`<b style='font-size: 1.2em; color:white'>\ días </b>`; 

document.getElementById("hours").innerHTML = `
<b style='font-size: 2.6em; color:white'>\ ${hours}</b>` +
 `<b style='font-size: 1.2em; color:white'>\ horas </b>`; 

 document.getElementById("mins").innerHTML = `
<b style='font-size: 2.6em; color:white'>\ ${minutes}</b>` +
 `<b style='font-size: 1.2em; color:white'>\ minutos </b>`;  

 document.getElementById("secs").innerHTML = `
<b style='font-size: 2.6em; color:white'>\ ${seconds}</b>` +
